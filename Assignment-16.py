...
a.execute("INSERT INTO Books(Book_ID,Title_ID,Location,Genre) VALUES(1,1,'Delhi','ishika')")
...
a.execute("INSERT INTO Publishers(Publishers_ID, Name,Street_Address,Zip_Code_ID) VALUES('gargishika1998@gmai.com','Ishika Garg','Delhi',110012)")
...
a.execute("INSERT INTO Authors(Authors_ID,First_Name,Middle_Name,Last_Name) VALUES('1','Miss','Ishika','Garg')")
a.commit()
...
a.execute("UPDATE Books set Title_ID=2 where Genre='ishika'")
a.execute("UPDATE Authors set Authors_ID=2 where Middle_Name='Ishika'")
a.commit()
